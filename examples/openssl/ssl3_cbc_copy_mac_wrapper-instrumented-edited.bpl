...
$bb0:
  ...
  assume true;
  assume {:sourceloc "/home/mbb/ct-verif/examples/openssl/ssl3_cbc_copy_mac.c", 39, 5} true;
  $p1 := rec;
  ...
  assume {:sourceloc "/home/mbb/ct-verif/examples/openssl/ssl3_cbc_copy_mac.c", 40, 5} true;
  ...
  assume {:sourceloc "/home/mbb/ct-verif/examples/openssl/ssl3_cbc_copy_mac.c", 54, 5} true;
  $p4 := $p0;
  $p4.shadow := $p0.shadow;
  assume {:sourceloc "/home/mbb/ct-verif/examples/openssl/ssl3_cbc_copy_mac.c", 54, 5} true;
  $p5 := $p0;
  ...
  assume {:sourceloc "/home/mbb/ct-verif/examples/openssl/ssl3_cbc_copy_mac.c", 58, 9} true;
...
$bb1:
  assume ($i12 == 1);
  assume {:sourceloc "/home/mbb/ct-verif/examples/openssl/ssl3_cbc_copy_mac.c", 59, 9} true;
...
$bb2:
  ...
  goto $bb3;
$bb3:
  assume {:sourceloc "/home/mbb/ct-verif/examples/openssl/ssl3_cbc_copy_mac.c", 68, 5} true;
  $i17 := $lshr.i32(md_size,1);
  $i17.shadow := $lshr.i32(md_size.shadow,1);
  call {:cexpr "div_spoiler"} boogie_si_record_i32($i17);
  assume {:sourceloc "/home/mbb/ct-verif/examples/openssl/ssl3_cbc_copy_mac.c", 69, 5} true;
  $i18 := $shl.i32($i17,24);
  $i18.shadow := $shl.i32($i17.shadow,24);
  call {:cexpr "div_spoiler"} boogie_si_record_i32($i18);
  assume {:sourceloc "/home/mbb/ct-verif/examples/openssl/ssl3_cbc_copy_mac.c", 70, 5} true;
  $i19 := $add.i32($i18,$i3);
  ...
  assume {:sourceloc "/home/mbb/ct-verif/examples/openssl/ssl3_cbc_copy_mac.c", 72, 5} true;
  ...
  assume {:sourceloc "/home/mbb/ct-verif/examples/openssl/ssl3_cbc_copy_mac.c", 73, 10} true;
  $i23, $i24 := $i13, 0;
...
$bb5:
  assume ($i25 == 1);
  assume {:sourceloc "/home/mbb/ct-verif/examples/openssl/ssl3_cbc_copy_mac.c", 74, 37} true;
  call $i26, $i26.shadow := constant_time_ge_8($i23, $i23.shadow, $i3, $i3.shadow);
  call {:cexpr "mac_started"} boogie_si_record_i8($i26);
  assume {:sourceloc "/home/mbb/ct-verif/examples/openssl/ssl3_cbc_copy_mac.c", 75, 35} true;
  call $i27, $i27.shadow := constant_time_ge_8($i23, $i23.shadow, $i2, $i2.shadow);
  call {:cexpr "mac_ended"} boogie_si_record_i8($i27);
  assume {:sourceloc "/home/mbb/ct-verif/examples/openssl/ssl3_cbc_copy_mac.c", 76, 9} true;
  ...
  assume {:sourceloc "/home/mbb/ct-verif/examples/openssl/ssl3_cbc_copy_mac.c", 77, 9} true;
  $i33 := $zext.i8.i32($i32);
  ...
  assume {:sourceloc "/home/mbb/ct-verif/examples/openssl/ssl3_cbc_copy_mac.c", 78, 14} true;
  ...
  assume {:sourceloc "/home/mbb/ct-verif/examples/openssl/ssl3_cbc_copy_mac.c", 73, 47} true;
  $i49 := $add.i32($i23,1);
...
$bb6:
  ...
  assume {:sourceloc "/home/mbb/ct-verif/examples/openssl/ssl3_cbc_copy_mac.c", 84, 10} true;
  $i50, $i51, $i52 := 0, 0, $i21;
...
$bb8:
  assume ($i53 == 1);
  assume {:sourceloc "/home/mbb/ct-verif/examples/openssl/ssl3_cbc_copy_mac.c", 86, 9} true;
  $i54 := $xor.i32($i52,32);
  ...
  assume {:sourceloc "/home/mbb/ct-verif/examples/openssl/ssl3_cbc_copy_mac.c", 87, 9} true;
  $i59 := $add.i32($i52,1);
  ...
  assume {:sourceloc "/home/mbb/ct-verif/examples/openssl/ssl3_cbc_copy_mac.c", 88, 26} true;
  ...
  assume {:sourceloc "/home/mbb/ct-verif/examples/openssl/ssl3_cbc_copy_mac.c", 84, 30} true;
  $i69 := $add.i32($i50,1);
...
$bb9:
  assume !($i53 == 1);
  assume {:sourceloc "/home/mbb/ct-verif/examples/openssl/ssl3_cbc_copy_mac.c", 101, 1} true;
  $exn := false;
  $exn.shadow := false;
  return;
}
