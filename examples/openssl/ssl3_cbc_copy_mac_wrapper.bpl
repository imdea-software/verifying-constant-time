...
// via ../tools/smack/bin/smack.py -t --verifier=boogie --entry-points ssl3_cbc_copy_mac_wrapper -bpl /home/mbb/ct-verif/examples/openssl/ssl3_cbc_copy_mac_wrapper.bpl /home/mbb/ct-verif/examples/openssl/ssl3_cbc_copy_mac_wrapper.c
...
procedure {:inline 2} ssl3_cbc_copy_mac(out: ref, rec: ref, md_size: i32, orig_len: i32)
{
  var $i10: i32;
  var $i11: i32;
  var $i12: i1;
...
$bb3:
  ...
  assume {:sourceloc "/home/mbb/ct-verif/examples/openssl/ssl3_cbc_copy_mac.c", 109, 5} true;
  call $M.1 := $memset.i8($M.1, $p9, 0, $i22, $zext.i32.i64(1), (0 == 1));
...
$bb5:
  ...
  call $i26 := constant_time_ge_8($i23, $i3);
  ...
  call $i27 := constant_time_ge_8($i23, $i2);
  ...
  call $i47 := constant_time_lt($i39, md_size);
  assume {:sourceloc "/home/mbb/ct-verif/examples/openssl/ssl3_cbc_copy_mac.c", 115, 14} true;
  $i48 := $and.i32($i39, $i47);
...
$bb8:
  ...
  call $i67 := constant_time_lt($i59, md_size);
  assume {:sourceloc "/home/mbb/ct-verif/examples/openssl/ssl3_cbc_copy_mac.c", 125, 26} true;
  $i68 := $and.i32($i59, $i67);
...
procedure {:entrypoint} ssl3_cbc_copy_mac_wrapper(out: ref, data: ref, length: i32, md_size: i32, orig_len: i32)
{
  var $p0: ref;
  var $p1: ref;
  var $p2: ref;
...
$bb0:
  ...
  call $p4 := __SMACK_value.i32(md_size);
  ...
  call $p5 := __SMACK_value.i32(orig_len);
  ...
  call ssl3_cbc_copy_mac(out, $p0, md_size, orig_len);
  assume {:sourceloc "/home/mbb/ct-verif/examples/openssl/ssl3_cbc_copy_mac_wrapper.c", 24, 10} true;
  $exn := false;
  return;
}
