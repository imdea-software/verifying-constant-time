...
// via ../tools/smack/bin/smack.py -t --verifier=boogie --entry-points ssl3_cbc_remove_padding_wrapper -bpl /home/mbb/ct-verif/examples/openssl/ssl3_cbc_remove_padding_wrapper.bpl /home/mbb/ct-verif/examples/openssl/ssl3_cbc_remove_padding_wrapper.c
...
procedure {:inline 2} __SMACK_value.i32($i0: i32)
  returns ($r: ref);
procedure {:inline 2} __SMACK_value.ref($p1: ref)
  returns ($r: ref);
...
procedure {:inline 2} ssl3_cbc_remove_padding(s: ref, rec: ref, block_size: i32, mac_size: i32)
  returns ($r: i32)
{
  var $i0: i32;
  var $i12: i8;
...
$bb2:
  ...
  $i16 := $add.i32($i13, $i0);
  assume {:sourceloc "/home/mbb/ct-verif/examples/openssl/ssl3_cbc_remove_padding.c", 66, 12} true;
  call $i17 := constant_time_ge($i15, $i16);
  ...
  $i18 := $add.i32($i13, 1);
  assume {:sourceloc "/home/mbb/ct-verif/examples/openssl/ssl3_cbc_remove_padding.c", 68, 13} true;
  call $i19 := constant_time_ge(block_size, $i18);
  assume {:sourceloc "/home/mbb/ct-verif/examples/openssl/ssl3_cbc_remove_padding.c", 68, 13} true;
  $i20 := $and.i32($i17, $i19);
  ...
  call $i30 := constant_time_select_int($i20, 1, $sub.i32(0, 1));
  assume {:sourceloc "/home/mbb/ct-verif/examples/openssl/ssl3_cbc_remove_padding.c", 72, 12} true;
  $i4 := $i30;
  goto $bb3;
$bb3:
...
procedure {:entrypoint} ssl3_cbc_remove_padding_wrapper(data: ref, length: i32, block_size: i32, mac_size: i32)
  returns ($r: i32)
{
  var $i12: i32;
  var $p0: ref;
...
$bb0:
  ...
  call $p5 := __SMACK_value.i32(mac_size);
  ...
  assume {:sourceloc "/home/mbb/ct-verif/examples/openssl/ssl3_cbc_remove_padding_wrapper.c", 21, 3} true;
  call $M.4 := $memset.i8($M.4, $p6, 0, 40, $zext.i32.i64(8), (0 == 1));
  assume {:sourceloc "/home/mbb/ct-verif/examples/openssl/ssl3_cbc_remove_padding_wrapper.c", 21, 3} true;
  ...
  call $i12 := ssl3_cbc_remove_padding($p0, $p1, block_size, mac_size);
  assume {:sourceloc "/home/mbb/ct-verif/examples/openssl/ssl3_cbc_remove_padding_wrapper.c", 27, 10} true;
  $r := $i12;
  $exn := false;
  return;
