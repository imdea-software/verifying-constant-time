...
axiom ($GLOBALS_BOTTOM == $sub.ref(0,236));
...
const ssl3_cbc_remove_padding_wrapper: ref;
...
procedure {:inline 2} ssl3_cbc_remove_padding(s: ref, s.shadow: ref, rec: ref, rec.shadow: ref, block_size: i32, block_size.shadow: i32, mac_size: i32, mac_size.shadow: i32) returns ($r: i32, $r.shadow: i32)
{
  var $i0: i32;
  var $i0.shadow: i32;
  var $i12: i8;
...
$bb0:
  ...
  assume {:sourceloc "/home/mbb/ct-verif/examples/openssl/ssl3_cbc_remove_padding.c", 57, 5} true;
  $i0 := $add.i32(1,mac_size);
  $i0.shadow := $add.i32(1,mac_size.shadow);
  call {:cexpr "overhead"} boogie_si_record_i32($i0);
  assume {:sourceloc "/home/mbb/ct-verif/examples/openssl/ssl3_cbc_remove_padding.c", 62, 9} true;
  $p1 := rec;
  ...
  assume {:sourceloc "/home/mbb/ct-verif/examples/openssl/ssl3_cbc_remove_padding.c", 62, 9} true;
  $i3 := $ugt.i32($i0,$i2);
  $i3.shadow := $ugt.i32($i0.shadow,$i2.shadow);
  assume {:sourceloc "/home/mbb/ct-verif/examples/openssl/ssl3_cbc_remove_padding.c", 62, 9} true;
...
$bb1:
  assume ($i3 == 1);
  assume {:sourceloc "/home/mbb/ct-verif/examples/openssl/ssl3_cbc_remove_padding.c", 63, 9} true;
  $i4 := 0;
  $i4.shadow := 0;
  goto $bb3;
$bb2:
  assume !($i3 == 1);
  assume {:sourceloc "/home/mbb/ct-verif/examples/openssl/ssl3_cbc_remove_padding.c", 65, 5} true;
  $p5 := rec;
  $p5.shadow := rec.shadow;
  assume {:sourceloc "/home/mbb/ct-verif/examples/openssl/ssl3_cbc_remove_padding.c", 65, 5} true;
  assert ($p5 == $p5.shadow);
  $i6 := $load.i32($M.0,$p5);
  ...
  assume {:sourceloc "/home/mbb/ct-verif/examples/openssl/ssl3_cbc_remove_padding.c", 65, 5} true;
  $i7 := $sub.i32($i6,1);
  $i7.shadow := $sub.i32($i6.shadow,1);
  assume {:sourceloc "/home/mbb/ct-verif/examples/openssl/ssl3_cbc_remove_padding.c", 65, 5} true;
  $i8 := $zext.i32.i64($i7);
  $i8.shadow := $zext.i32.i64($i7.shadow);
  assume {:sourceloc "/home/mbb/ct-verif/examples/openssl/ssl3_cbc_remove_padding.c", 65, 5} true;
  $p9 := $add.ref(rec,8);
  $p9.shadow := $add.ref(rec.shadow,8);
  assume {:sourceloc "/home/mbb/ct-verif/examples/openssl/ssl3_cbc_remove_padding.c", 65, 5} true;
  assert ($p9 == $p9.shadow);
  $p10 := $load.ref($M.1,$p9);
  $p10.shadow := $load.ref($M.1.shadow,$p9.shadow);
  assume {:sourceloc "/home/mbb/ct-verif/examples/openssl/ssl3_cbc_remove_padding.c", 65, 5} true;
  $p11 := $add.ref($p10,$mul.ref($i8,1));
  $p11.shadow := $add.ref($p10.shadow,$mul.ref($i8.shadow,1));
  assume {:sourceloc "/home/mbb/ct-verif/examples/openssl/ssl3_cbc_remove_padding.c", 65, 5} true;
  assert ($p11 == $p11.shadow);
  $i12 := $load.i8($M.2,$p11);
  $i12.shadow := $load.i8($M.2.shadow,$p11.shadow);
  assume {:sourceloc "/home/mbb/ct-verif/examples/openssl/ssl3_cbc_remove_padding.c", 65, 5} true;
  $i13 := $zext.i8.i32($i12);
  $i13.shadow := $zext.i8.i32($i12.shadow);
  call {:cexpr "padding_length"} boogie_si_record_i32($i13);
  assume {:sourceloc "/home/mbb/ct-verif/examples/openssl/ssl3_cbc_remove_padding.c", 66, 12} true;
  $p14 := rec;
  $p14.shadow := rec.shadow;
  assume {:sourceloc "/home/mbb/ct-verif/examples/openssl/ssl3_cbc_remove_padding.c", 66, 12} true;
  ...
  assume {:sourceloc "/home/mbb/ct-verif/examples/openssl/ssl3_cbc_remove_padding.c", 66, 12} true;
  $i16 := $add.i32($i13,$i0);
  $i16.shadow := $add.i32($i13.shadow,$i0.shadow);
  assume {:sourceloc "/home/mbb/ct-verif/examples/openssl/ssl3_cbc_remove_padding.c", 66, 12} true;
  call $i17, $i17.shadow := constant_time_ge($i15, $i15.shadow, $i16, $i16.shadow);
  call {:cexpr "good"} boogie_si_record_i32($i17);
  assume {:sourceloc "/home/mbb/ct-verif/examples/openssl/ssl3_cbc_remove_padding.c", 68, 13} true;
  $i18 := $add.i32($i13,1);
  $i18.shadow := $add.i32($i13.shadow,1);
  assume {:sourceloc "/home/mbb/ct-verif/examples/openssl/ssl3_cbc_remove_padding.c", 68, 13} true;
  call $i19, $i19.shadow := constant_time_ge(block_size, block_size.shadow, $i18, $i18.shadow);
  assume {:sourceloc "/home/mbb/ct-verif/examples/openssl/ssl3_cbc_remove_padding.c", 68, 13} true;
  $i20 := $and.i32($i17,$i19);
  $i20.shadow := $and.i32($i17.shadow,$i19.shadow);
  call {:cexpr "good"} boogie_si_record_i32($i20);
  assume {:sourceloc "/home/mbb/ct-verif/examples/openssl/ssl3_cbc_remove_padding.c", 69, 5} true;
  $i21 := $add.i32($i13,1);
  $i21.shadow := $add.i32($i13.shadow,1);
  assume {:sourceloc "/home/mbb/ct-verif/examples/openssl/ssl3_cbc_remove_padding.c", 69, 5} true;
  $i22 := $and.i32($i20,$i21);
  $i22.shadow := $and.i32($i20.shadow,$i21.shadow);
  call {:cexpr "padding_length"} boogie_si_record_i32($i22);
  assume {:sourceloc "/home/mbb/ct-verif/examples/openssl/ssl3_cbc_remove_padding.c", 70, 5} true;
  $p23 := rec;
  $p23.shadow := rec.shadow;
  assume {:sourceloc "/home/mbb/ct-verif/examples/openssl/ssl3_cbc_remove_padding.c", 70, 5} true;
  ...
  assume {:sourceloc "/home/mbb/ct-verif/examples/openssl/ssl3_cbc_remove_padding.c", 70, 5} true;
  $i25 := $sub.i32($i24,$i22);
  $i25.shadow := $sub.i32($i24.shadow,$i22.shadow);
  assume {:sourceloc "/home/mbb/ct-verif/examples/openssl/ssl3_cbc_remove_padding.c", 70, 5} true;
  assert ($p23 == $p23.shadow);
  $M.0 := $store.i32($M.0,$p23,$i25);
  $M.0.shadow := $store.i32($M.0.shadow,$p23.shadow,$i25.shadow);
  assume {:sourceloc "/home/mbb/ct-verif/examples/openssl/ssl3_cbc_remove_padding.c", 71, 5} true;
  $i26 := $shl.i32($i22,8);
  $i26.shadow := $shl.i32($i22.shadow,8);
  assume {:sourceloc "/home/mbb/ct-verif/examples/openssl/ssl3_cbc_remove_padding.c", 71, 5} true;
  $p27 := $add.ref(rec,16);
  $p27.shadow := $add.ref(rec.shadow,16);
  assume {:sourceloc "/home/mbb/ct-verif/examples/openssl/ssl3_cbc_remove_padding.c", 71, 5} true;
  ...
  assume {:sourceloc "/home/mbb/ct-verif/examples/openssl/ssl3_cbc_remove_padding.c", 71, 5} true;
  $i29 := $or.i32($i28,$i26);
  $i29.shadow := $or.i32($i28.shadow,$i26.shadow);
  assume {:sourceloc "/home/mbb/ct-verif/examples/openssl/ssl3_cbc_remove_padding.c", 71, 5} true;
  assert ($p27 == $p27.shadow);
  $M.3 := $store.i32($M.3,$p27,$i29);
  $M.3.shadow := $store.i32($M.3.shadow,$p27.shadow,$i29.shadow);
  assume {:sourceloc "/home/mbb/ct-verif/examples/openssl/ssl3_cbc_remove_padding.c", 72, 12} true;
  call $i30, $i30.shadow := constant_time_select_int($i20, $i20.shadow, 1, 1, $sub.i32(0,1), $sub.i32(0,1));
  assume {:sourceloc "/home/mbb/ct-verif/examples/openssl/ssl3_cbc_remove_padding.c", 72, 12} true;
  $i4 := $i30;
  $i4.shadow := $i30.shadow;
  goto $bb3;
$bb3:
  assume {:sourceloc "/home/mbb/ct-verif/examples/openssl/ssl3_cbc_remove_padding.c", 73, 1} true;
  $r := $i4;
  $r.shadow := $i4.shadow;
  $exn := false;
  $exn.shadow := false;
...
procedure {:entrypoint} ssl3_cbc_remove_padding_wrapper({:public_in_value} data: ref, data.shadow: ref, {:public_in_value} length: i32, length.shadow: i32, {:public_in_value} block_size: i32, block_size.shadow: i32, {:public_in_value} mac_size: i32, mac_size.shadow: i32) returns ($r: i32, $r.shadow: i32)
...
$bb0:
  ...
  call $p0 := $alloc($mul.ref(40,1));
  $p0.shadow := $p0;
  assert ($mul.ref(32,1) == $mul.ref(32,1));
  call $p1 := $alloc($mul.ref(32,1));
  $p1.shadow := $p1;
  call {:cexpr "data"} boogie_si_record_ref(data);
  call {:cexpr "length"} boogie_si_record_i32(length);
  call {:cexpr "block_size"} boogie_si_record_i32(block_size);
  call {:cexpr "mac_size"} boogie_si_record_i32(mac_size);
  assume {:sourceloc "/home/mbb/ct-verif/examples/openssl/ssl3_cbc_remove_padding_wrapper.c", 13, 19} true;
  call $p2, $p2.shadow := __SMACK_value.ref(data, data.shadow);
  assume $isExternal($p2);
  assume {:sourceloc "/home/mbb/ct-verif/examples/openssl/ssl3_cbc_remove_padding_wrapper.c", 13, 3} true;
  call public_in_value($p2, $p2.shadow);
  assume {:sourceloc "/home/mbb/ct-verif/examples/openssl/ssl3_cbc_remove_padding_wrapper.c", 16, 19} true;
  call $p3, $p3.shadow := __SMACK_value.i32(length, length.shadow);
  assume $isExternal($p3);
  assume {:sourceloc "/home/mbb/ct-verif/examples/openssl/ssl3_cbc_remove_padding_wrapper.c", 16, 3} true;
  call public_in_value($p3, $p3.shadow);
  assume {:sourceloc "/home/mbb/ct-verif/examples/openssl/ssl3_cbc_remove_padding_wrapper.c", 17, 19} true;
  call $p4, $p4.shadow := __SMACK_value.i32(block_size, block_size.shadow);
  assume $isExternal($p4);
  assume {:sourceloc "/home/mbb/ct-verif/examples/openssl/ssl3_cbc_remove_padding_wrapper.c", 17, 3} true;
  call public_in_value($p4, $p4.shadow);
  assume {:sourceloc "/home/mbb/ct-verif/examples/openssl/ssl3_cbc_remove_padding_wrapper.c", 18, 19} true;
  call $p5, $p5.shadow := __SMACK_value.i32(mac_size, mac_size.shadow);
  assume $isExternal($p5);
  assume {:sourceloc "/home/mbb/ct-verif/examples/openssl/ssl3_cbc_remove_padding_wrapper.c", 18, 3} true;
  call public_in_value($p5, $p5.shadow);
  assume true;
  assume {:sourceloc "/home/mbb/ct-verif/examples/openssl/ssl3_cbc_remove_padding_wrapper.c", 21, 3} true;
  ...
  assert (0 == 0);
  assert (40 == 40);
  assert ($zext.i32.i64(8) == $zext.i32.i64(8));
  assert ((0 == 1) == (0 == 1));
  call $M.4, $M.4.shadow := $memset.i8($M.4, $M.4.shadow, $p6, $p6.shadow, 0, 0, 40, 40, $zext.i32.i64(8), $zext.i32.i64(8), (0 == 1), (0 == 1));
  assume {:sourceloc "/home/mbb/ct-verif/examples/openssl/ssl3_cbc_remove_padding_wrapper.c", 21, 3} true;
  $p7 := $bitcast.ref.ref($p6);
  $p7.shadow := $bitcast.ref.ref($p6.shadow);
  call {:cexpr "s"} boogie_si_record_ref($p0);
  assume true;
  assume {:sourceloc "/home/mbb/ct-verif/examples/openssl/ssl3_cbc_remove_padding_wrapper.c", 25, 3} true;
  $p8 := $p1;
  $p8.shadow := $p1.shadow;
  assume {:sourceloc "/home/mbb/ct-verif/examples/openssl/ssl3_cbc_remove_padding_wrapper.c", 25, 3} true;
  assert ($p8 == $p8.shadow);
  $M.0 := $store.i32($M.0,$p8,length);
  $M.0.shadow := $store.i32($M.0.shadow,$p8.shadow,length.shadow);
  assume {:sourceloc "/home/mbb/ct-verif/examples/openssl/ssl3_cbc_remove_padding_wrapper.c", 25, 3} true;
  $p9 := $add.ref($p1,8);
  $p9.shadow := $add.ref($p1.shadow,8);
  assume {:sourceloc "/home/mbb/ct-verif/examples/openssl/ssl3_cbc_remove_padding_wrapper.c", 25, 3} true;
  assert ($p9 == $p9.shadow);
  $M.1 := $store.ref($M.1,$p9,data);
  $M.1.shadow := $store.ref($M.1.shadow,$p9.shadow,data.shadow);
  assume {:sourceloc "/home/mbb/ct-verif/examples/openssl/ssl3_cbc_remove_padding_wrapper.c", 25, 3} true;
  $p10 := $add.ref($p1,16);
  $p10.shadow := $add.ref($p1.shadow,16);
  assume {:sourceloc "/home/mbb/ct-verif/examples/openssl/ssl3_cbc_remove_padding_wrapper.c", 25, 3} true;
  assert ($p10 == $p10.shadow);
  $M.3 := $store.i32($M.3,$p10,0);
  $M.3.shadow := $store.i32($M.3.shadow,$p10.shadow,0);
  assume {:sourceloc "/home/mbb/ct-verif/examples/openssl/ssl3_cbc_remove_padding_wrapper.c", 25, 3} true;
  $p11 := $add.ref($p1,24);
  $p11.shadow := $add.ref($p1.shadow,24);
  assume {:sourceloc "/home/mbb/ct-verif/examples/openssl/ssl3_cbc_remove_padding_wrapper.c", 25, 3} true;
  assert ($p11 == $p11.shadow);
  $M.5 := $store.ref($M.5,$p11,$0.ref);
  $M.5.shadow := $store.ref($M.5.shadow,$p11.shadow,$0.ref);
  assume {:sourceloc "/home/mbb/ct-verif/examples/openssl/ssl3_cbc_remove_padding_wrapper.c", 27, 10} true;
  call $i12, $i12.shadow := ssl3_cbc_remove_padding($p0, $p0.shadow, $p1, $p1.shadow, block_size, block_size.shadow, mac_size, mac_size.shadow);
  assume {:sourceloc "/home/mbb/ct-verif/examples/openssl/ssl3_cbc_remove_padding_wrapper.c", 27, 10} true;
  $r := $i12;
  $r.shadow := $i12.shadow;
  $exn := false;
...
axiom (ssl3_cbc_remove_padding == $sub.ref(0,148));
axiom (ssl3_cbc_remove_padding_wrapper == $sub.ref(0,156));
axiom (public_in_value == $sub.ref(0,164));
axiom (__SMACK_value == $sub.ref(0,172));
axiom (llvm.memset.p0i8.i64 == $sub.ref(0,180));
axiom (constant_time_ge == $sub.ref(0,188));
axiom (constant_time_select_int == $sub.ref(0,196));
axiom (constant_time_select == $sub.ref(0,204));
axiom (constant_time_lt == $sub.ref(0,212));
axiom (constant_time_msb == $sub.ref(0,220));
axiom (llvm.dbg.value == $sub.ref(0,228));
axiom (__SMACK_static_init == $sub.ref(0,236));
